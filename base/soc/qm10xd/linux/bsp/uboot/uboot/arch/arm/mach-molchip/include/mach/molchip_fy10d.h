...
#define		CLG_USB2_UTMI0_CFG				(REG_AP_SYS_CLK_CFG + 0x28)
#define		CLK_USB2_UTMI1_CFG				(REG_AP_SYS_CLK_CFG + 0x2c)
#define 	CLK_SFC_CFG						(REG_AP_SYS_CLK_CFG + 0x30)//0: 24m	1: 64m	2: 91_4m	default: 2'h0
#define 	CLK_EFUSE_CFG					(REG_AP_SYS_CLK_CFG + 0x38)//0: 24m	1: 64m	2: 91_4m	default: 2'h0
#define     CLK_UART0_CFG                   (REG_AP_SYS_CLK_CFG + 0x5c)//0: 24m     1: 64m  2: 100m         3: 128m         default: 2'h0
#define     CLK_UART1_CFG                   (REG_AP_SYS_CLK_CFG + 0x60)
#define     CLK_AP_SYS_CFG                  (REG_AP_SYS_CLK_CFG + 0x90)
#define     CLK_SDIO0_CFG                   (REG_AP_SYS_CLK_CFG + 0x94) //0:24M 1:50M 2:100M 3:200M
#define     CLK_SDIO0_DLLREF_CFG            (REG_AP_SYS_CLK_CFG + 0x98) //0:100M


#define		REG_TOP_CLK_GEN					(0x28100200)
#define		CLK_GLB_APB_CFG					(REG_TOP_CLK_GEN + 0x2c)//0: 24m	1: 64m	2: 100m 	3: 200m 	default: 2'h0
#define		CLK_GBL_VIO_CFG					(REG_TOP_CLK_GEN + 0x30)//0: 24m	1: 100m 2: 200m 	default: 2'h0
