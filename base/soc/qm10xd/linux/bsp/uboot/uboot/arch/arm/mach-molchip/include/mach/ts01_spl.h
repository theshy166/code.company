...
#define SPL_DOWN_ADDR			0x80005000
#define SPL_LOAD_ADDR			0x04010000
#define SPL_NAND_LOCATION_OFFS		(16 << 10)
#define SPL_NOR_LOCATION_OFFS        	(0 << 10)
#define SPL_MAX_SIZE			0x2000

#define UBOOT_DOWN_ADDR                 0x80008000
#define UBOOT_LOAD_ADDR			0x81600000
#define UBOOT_NAND_LOCATION_OFFS          (32 << 10)
#define UBOOT_NOR_LOCATION_OFFS           (64 << 10)
#define UBOOT_MAX_SIZE			0x40000

#define KERNEL_DOWN_ADDR                   0x80048000
#define KERNEL_LOAD_ADDR		   0x80008000
#define KERNEL_NAND_LOCATION_OFFS          (48 << 10)
#define KERNEL_NOR_LOCATION_OFFS           (320 << 10)
#define KERNEL_MAX_SIZE			0x400000


#define DTB_DOWN_ADDR			0x80448000
#define DTB_LOAD_ADDR                   0x81000000
#define DTB_NOR_LOCATION_OFFS		(4416 << 10)
#define DTB_MAX_SIZE 			0x1000

#define DISK_DOWN_ADDR			0x80450000
#define DISK_LOAD_ADDR			0x81008000
