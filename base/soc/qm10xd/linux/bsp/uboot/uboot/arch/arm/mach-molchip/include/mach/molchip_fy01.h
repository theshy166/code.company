...
#define 	REG_UART0_BASE					 (0x18300000)
#define		REG_UART1_BASE					 (0x18400000)
...
#define 	CLK_SPIC_SSI_CFG				(REG_AP_SYS_CLK_CFG + 0x30)//0: 24m	1: 64m	2: 91_4m	default: 2'h0
#define     CLK_UART0_CFG                   (REG_AP_SYS_CLK_CFG + 0x58)//0: 24m     1: 64m  2: 100m         3: 128m         default: 2'h0
#define     CLK_UART1_CFG                   (REG_AP_SYS_CLK_CFG + 0x5c)
...
#define		CKG_EPHY_REF_EN					(REG_GLB_APB_BASE + 0xb8)

#define 	REG_ANALOG_BASE					(0x28500000)


#define 	HEAP_BASE						0x38B53000
#define		HEAP_LIMIT						0x38B55000
