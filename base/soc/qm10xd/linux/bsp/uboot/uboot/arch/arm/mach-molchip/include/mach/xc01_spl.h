...
#define SPL_LOAD_ADDR			0x30000000
...
#define HEADER_LEN			0x800

#define UBOOT_DOWN_ADDR                 0x41000000
#define UBOOT_LOAD_ADDR			0x41600000
#define UBOOT_NAND_LOCATION_OFFS          (832 << 11)
#define UBOOT_NOR_LOCATION_OFFS           (3072 << 10)
...
#define KERNEL_NAND_LOCATION_OFFS          (2048 << 10)
#define KERNEL_NOR_LOCATION_OFFS           (4096 << 10)
...
#define RTT_DOWN_ADDR                 0x41000000
