...
spi_mpi_ioctrl_t spi_mpi_ioctrl_fun[] = {
    {spi_cmd_bit_width, _spi_mpi_bit_width_set},
    {spi_cmd_tx_mode,   _spi_mpi_tx_mode_set},
    {spi_cmd_rx_mode,   _spi_mpi_rx_mode_set},
    {spi_cmd_debug_log, _spi_mpi_debug_log_set},
    {spi_cmd_max, NULL}
};
