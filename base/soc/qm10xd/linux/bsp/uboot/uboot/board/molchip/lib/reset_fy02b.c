...
#define REG_POR_FLAG4     (0x28000034)
#define REG_POR_FLAG5     (0x28000038)
#define REG_POR_FLAG6     (0x2800003c)
#define REG_RST_CTRL      (0x280000ac)

#define REG_RST_WR_PR     (0x280000b0)
...
unsigned int MC_GetResetType(void)
{
	...
	*(volatile unsigned int*)REG_POR_FLAG6 = 1;
	...
	/* enable reg write protect */
	*(volatile unsigned int*)(REG_RST_WR_PR) = 0;
	...
	if ((por_flag[0] == 0) && (por_flag[1] == 0) && (por_flag[5] == 0))
		...
		return NO__RST;
#else
	if ((por_flag[0] == 0) && (por_flag[1] == 0) && (por_flag[3] == 0) && (por_flag[4] == 1) && (por_flag[5] == 0) && (por_flag[6] == 0))
		return POR_RST;
