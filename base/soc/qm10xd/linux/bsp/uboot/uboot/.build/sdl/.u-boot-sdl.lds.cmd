cmd_sdl/u-boot-sdl.lds := arm-molv2-linux-uclibcgnueabi-gcc -E -Wp,-MD,sdl/.u-boot-sdl.lds.d -D__KERNEL__ -D__UBOOT__ -DLOGO_YADDR0=0x43E00000	 -DLOGO_CADDR0=0x43E98000	 -DLOGO_YADDR1=0x00000000	 -DLOGO_CADDR1=0x00000000	 -DCONFIG_SDL_BUILD -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe  -march=armv7-a -D__LINUX_ARM_ARCH__=7  -I../arch/arm/mach-molchip/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h -I../arch/arm/mach-molchip/include -nostdinc -isystem /home/luoxin/work/X-AIOS-ESL/tools/toolchain/arm-molv2-linux-uclibcgnueabi/bin/../lib/gcc/arm-molv2-linux-uclibcgnueabi/10.3.1/include -include ../include/u-boot/u-boot.lds.h -include ./include/config.h -DCPUDIR=arch/arm/cpu/armv7  -ansi -D__ASSEMBLY__ -x assembler-with-cpp -P -o sdl/u-boot-sdl.lds ../arch/arm/cpu/u-boot-sdl.lds

source_sdl/u-boot-sdl.lds := ../arch/arm/cpu/u-boot-sdl.lds

deps_sdl/u-boot-sdl.lds := \
...
sdl/u-boot-sdl.lds: $(deps_sdl/u-boot-sdl.lds)
