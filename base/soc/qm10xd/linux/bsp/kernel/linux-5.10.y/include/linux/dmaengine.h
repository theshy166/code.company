 ...
 * @DMA_SPILT_TO_I2S_AUDIO: I2s Spilt mode & Spilt Mem data to I2s Audio
 */
...
struct dma_chan {
	...
	void *route_data;
	/* DMA interrupt count */
	size_t dma_cycle_buf_len_count;
	size_t dma_cycle_period_len;
	size_t dma_cycle_buf_len;
...
{
	return (direction == DMA_MEM_TO_DEV) || (direction == DMA_DEV_TO_MEM)  || (direction == DMA_SPILT_TO_I2S_AUDIO);
}
