...
#ifdef CONFIG_UVC_CLASS_REV_1_5_SUPPORT
#define UVC_CLASS_CODE (0x0150)
#define UVC_INTERFACE_PROTOCOL (0x01)
#define UVC_PROCESS_UNIT_DESC_LEN (13)
#else
#define UVC_CLASS_CODE (0x0100)
#define UVC_INTERFACE_PROTOCOL (0x00)
#define UVC_PROCESS_UNIT_DESC_LEN (12)
#endif
