...
struct dw_mci {
	...
	/* For cd detection */
	unsigned int	cd_detect_level;
	unsigned int	sd_id;
	unsigned int	ckg_mux_num;
	unsigned int	ckg_dllref_num;
	unsigned int	ckg_ahp_sdio_num;
	unsigned int	ckg_sdio_num;
#if CONFIG_PM_SLEEP
	unsigned int	suspend_wtime;	/* suspend waitting time */
	unsigned int	force_suspend;	/* if value is  1 measns force suspend*/
#endif
};
...
/* sdio ctrl pll */
#define CPU_SYS_AHB_BASE	(0x0c000000)
#define DMC_SYS_AHB_BASE	(0x24000000)
#define SDIO0_SPL1_REG		(0x220)
#define SDIO0_CTRL0_REG		(0x214)
#define SDIO1_DLLININFO_SPL_REG	(0xe18)
#define SDIO1_CTRL0_REG		(0xe34)
#define SDIO_DLLBYPASS_VALUE	BIT(2)
#define SDIO_DLLCLKSEL_VALUE	BIT(0)
#define SDIO_DLLININFO_VALUE	(0x9)

extern int dw_mci_probe(struct dw_mci *host);
extern void dw_mci_remove(struct dw_mci *host);

extern int mc_sd_resume(struct device *dev);
extern int mc_sd_suspend(struct device *dev);
