...
extern void mc_reset_controller_sys(struct ata_link *link);
extern void ata_eh_hbareset_port(struct ata_link *link);
extern bool ata_is_ahci_active(struct ata_link *link);
/* libata-core.c */
enum {
