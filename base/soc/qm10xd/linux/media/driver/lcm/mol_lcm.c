...
#include "dsi_mpi.h"
#include "ctrl_lcm_v01_drv.h"
#include "mol_lcm_table.h"
    ...
    if (LCM_TYPE_MAX > lcm_type) {
        ...
        switch(lcm_type){
            ...
            case LCM_TYPE_MIPI:
                ...
                ops->ctrl_fun.mipi.dcs_read = dsi_dcs_read_4_identify;
...
int32_t read_tab_index(lcm_handle_t *handle)
{
    ...
    rtn = ops->sfc.read(info, handle->lcm_probe.lcm_id, (uint32_t *)&lcm_index);
