...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_func_probe);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_func_probe);
#endif
...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_func_init);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_func_init);
#endif
...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_func_deinit);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_func_deinit);
#endif
...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_func_suspend);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_func_suspend);
#endif
...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_func_resume);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_func_resume);
#endif
...
#if defined(OS_LINUX)
EXPORT_SYMBOL(lcm_ioctrl);
#elif defined(OS_RTT)
RTM_EXPORT(lcm_ioctrl);
#endif
