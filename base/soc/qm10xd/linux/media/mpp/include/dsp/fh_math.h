...
** SPAN(FH_UINT32, 100, 200) is 200 - 100 = 100
** SPAN(FH_UINT32, 200, 100) is 0xFFFFFFFF - 200 + 100
** SPAN(FH_UINT64, 200, 100) is 0xFFFFFFFFFFFFFFFF - 200 + 100
******************************************************************************/
...
__inline static FH_BOOL IS_LITTLE_END(void)
{
    union unEND_TEST_U
    {
        FH_CHAR cTest[4];
    ...
    return (unEndTest.u32Test > 0x01020304) ? (FH_TRUE) : (FH_FALSE);
}
...
******************************************************************************/
__inline static FH_VOID Rgb2Yc(FH_UINT8 r, FH_UINT8 g, FH_UINT8 b, FH_UINT8 * py, FH_UINT8 * pcb, FH_UINT8 * pcr)
{
    /* Y */
    *py = (FH_UINT8)(((r*66+g*129+b*25) >> 8) + 16);

    /* Cb */
    *pcb = (FH_UINT8)((((b*112-r*38)-g*74) >> 8) + 128);

    /* Cr */
    *pcr = (FH_UINT8)((((r*112-g*94)-b*18) >> 8) + 128);
}

__inline static FH_UINT32 Rgb2Yuv(FH_UINT32 u32Rgb)
{
    FH_UINT8 y,u,v;
...
******************************************************************************/
__inline static FH_VOID GetYCFromRGB(FH_UINT32 rgb, FH_UINT32 * pY, FH_UINT32 * pC)
{
    FH_UINT8 y, cb, cr;
    FH_UINT32 color_y, color_c, tmp;
...
{
    FH_UINT32 u32Ffps;    /* Full frame rate    */
    FH_UINT32 u32Tfps;    /* Target frame rate  */
    FH_UINT32 u32FrmKey;  /* update key frame   */
} FPS_CTRL_S;

__inline static FH_VOID InitFps(FPS_CTRL_S *pFrmCtrl, FH_UINT32 u32FullFps,
                                FH_UINT32 u32TagFps)
{
...
__inline static FH_BOOL FpsControl(FPS_CTRL_S *pFrmCtrl)
{
    FH_BOOL   bReturn       = FH_FALSE;
...
*******************************************************************************/
    ...
    #include <sys/time.h>
#endif
__inline static FH_UINT32 GetSysTimeBySec(void)
{
    #ifdef __KERNEL__
        return 0;
    #else
...
__inline static FH_UINT64 GetSysTimeByUsec(void)
{
    #ifdef __KERNEL__
        return 0;
    #else
