...
#define FH_ERR_APPID  (0x80000000L + 0x20000000L)
...
#define FH_DEF_ERR( module, level, errid) \
    ((FH_SINT32)( (FH_ERR_APPID) | ((module) << 16 ) | ((level)<<13) | (errid) ))
...
typedef enum fyEN_ERR_CODE_E
{
    ...
    EN_ERR_TIMEOUT       = 10,/* operation timeout                            */
