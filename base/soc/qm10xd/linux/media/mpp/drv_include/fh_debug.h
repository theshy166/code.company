...
/* #ifdef FY_DEBUG */
    ...
    /* Using samples:
    ** FY_TRACE(FY_DBG_DEBUG, FH_ID_CMPI, "Test %d, %s\n", 12, "Test");
    **/
...
extern FH_SINT32 FY_ChkLogLevel(FH_SINT32 s32Levle, MOD_ID_E enModId);
asmlinkage int FY_LOG(FH_SINT32 level, MOD_ID_E enModId,const char *fmt, ...);
