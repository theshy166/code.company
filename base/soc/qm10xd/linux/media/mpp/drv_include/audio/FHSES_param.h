...
*/
int VQE_lib_version(void);
int VQE_lib_date(void);
int VQE_lib_idx_state(int id);
int VQE_Get_Current_Param(int id, void *p, int len);
int VQE_init(VQE_config * config);
int VQE_process(AUDIO_DEV AiDevId, VQE_config * config);
