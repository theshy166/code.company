...
#include "cfg/ovos04c10_mipi_2lane_1080p30.h"
#include "cfg/ovos04c10_mipi_2lane_400w15.h"
...
#include "cfg/ovos04c10_mipi_2lane_2688x1520p15.h"
...
{
	{
        ...
        .u32ConfSize      = sizeof(Sensor_Cfg_OVOS04C10_MIPI_1080p30_2LANE) / 4,
        .pu16CciConf      = Sensor_Cfg_OVOS04C10_MIPI_1080p30_2LANE,
	...
	{
        .u32SnsFmt       = FORMAT_400WP15,
        .u32ConfSize      = sizeof(Sensor_Cfg_OVOS04C10_MIPI_400w15_2LANE) / 4,
        .pu16CciConf      = Sensor_Cfg_OVOS04C10_MIPI_400w15_2LANE,
        .u8MipiClkRate  = R_1400_1499,
        .u8MipiLaneNum  = 2,
        .stSnsAttr       = &attr_2l_400w15,
    },
    ...
    {
        .u32SnsFmt       = FORMAT_2688X1520P15,
        .u32ConfSize      = sizeof(Sensor_Cfg_OVOS04C10_MIPI_2688X1520P15_2LANE) / 4,
        .pu16CciConf      = Sensor_Cfg_OVOS04C10_MIPI_2688X1520P15_2LANE,
        .u8MipiClkRate  = R_900_999,
        .u8MipiLaneNum  = 2,
        .stSnsAttr       = &attr_2l_2688x1520p15,
    },
