...
#define NAME(n) _NAME(n, sc2336_mipi)
#define CCI_ID      (0x60 >> 1)  //0x60 or 0x64
#define CCI_MODE    2
        ...
        case CMD_MAP_INTT_GAIN:
            {
                ...
                {
                    case FORMAT_540P60:
                        curr_format_param = 60;
                        curr_frame_height = FRAM_H_540P60_2L;
                        break;
                    default:
                        ret = -1;
                }
                ...
                switch (map_intt_gain->desFormat)
                {
                    case FORMAT_1080P15:
                        des_format_param = 15;
                        des_frame_height = FRAM_H_1080P15_2L;
                        break;
                    case FORMAT_1080P25:
                        des_format_param = 25;
                        des_frame_height = FRAM_H_1080P25_2L;
                        break;
                    case FORMAT_1080P30:
                        des_format_param = 30;
                        des_frame_height = FRAM_H_1080P30_2L;
                        break;
                    case FORMAT_720P25:
                        des_format_param = 25;
                        des_frame_height = FRAM_H_720P25_2L;
                        break;
                    case FORMAT_720P30:
                        des_format_param = 30;
                        des_frame_height = FRAM_H_720P30_2L;
                        break;
                    default:
                        ret = -1;
                }
...
static int Sensor_DeInit(void *pvObj)
{
    ...
    SensorReset(pvObj);
    mipi_deinit(pstCtrlPara->u8CsiDeviceId);
...
static int SetSensorFmt(void *pvObj, FH_SINT32 s32Format)
{
    ...
    fh_printf("sc2336 SetSensorFmt:0x%x\r\n", s32Format);
...
static int SetGain(void *pvObj, FH_UINT32 again, FH_UINT8 fNo)
{
    ...
    if (fNo == 0)
    {
        ...
        fh_printf("sc2336 [Reg3e06 Reg3e07 Reg3e09 u32CurrSnsGain]:[0x%x 0x%x 0x%x 0x%x]\n", Reg3e06, Reg3e07, Reg3e09, pstCtrlPara->u32CurrSnsGain);
    }
    return 0;
}
...
#define SENSOR_SC2336_MIPI "sc2336_mipi"
#ifdef OS_RTT
struct isp_sensor_if sc2336_mipi_sensor_if_default = {
#else
struct isp_sensor_if sc2336_mipi_sensor_if_default = {
#endif
    .name = SENSOR_SC2336_MIPI,
...
struct isp_sensor_if *NAME(Sensor_Create)()
{
    ...
    memcpy(s_if, &sc2336_mipi_sensor_if_default, sizeof(struct isp_sensor_if));
