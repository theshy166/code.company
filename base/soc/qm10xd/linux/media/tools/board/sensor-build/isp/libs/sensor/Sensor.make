...
export STATIC ?= 1
export DEBUG ?= 0
export CROSS_COMPILE ?= arm-mol-linux-uclibcgnueabihf-
...
CFLAGS += -I$(RTT_ROOT)/bsp/XC01
CFLAGS += -I$(RTT_ROOT)/bsp/XC01/driver
CFLAGS += -I$(RTT_ROOT)/components/libc/compilers/minilibc
CFLAGS += -I$(RTT_ROOT)/components
CFLAGS += -I$(RTT_ROOT)/components/finsh
CFLAGS += -I$(RTT_ROOT)/components/i2c
else
ifeq ($(RTOSV3),1)
CFLAGS += -I$(RTT_ROOT)/
