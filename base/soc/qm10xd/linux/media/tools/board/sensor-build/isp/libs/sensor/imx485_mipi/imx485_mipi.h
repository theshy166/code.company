...
*/
#ifndef IMX485_MIPI_H_
#define IMX485_MIPI_H_

#include "cfg/imx485_mipi_4lane_800wp25.h"
#include "cfg/imx485_mipi_4lane_720p25.h"
#include "cfg/imx485_mipi_4lane_800wp25_wdr.h"
...
static SNS_CONFIG_S stSnsConf0[]  =
{

    {
        ...
        .u32ConfSize      = sizeof(Sensor_Cfg_IMX485_MIPI_4LANE_800WP25) / 4,
        .pu16CciConf      = Sensor_Cfg_IMX485_MIPI_4LANE_800WP25,
        .u8MipiClkRate    = R_1400_1499,
        .u8MipiLaneNum    = 4,
        .stSnsAttr        = &attr_4l_800wp25,
        .u32SnsClk        = 27000000,
    },

    {
        .u32SnsFmt        = FORMAT_720P25,
        .u32ConfSize      = sizeof(Sensor_Cfg_IMX485_MIPI_4LANE_720P25) / 4,
        .pu16CciConf      = Sensor_Cfg_IMX485_MIPI_4LANE_720P25,
        .u8MipiClkRate    = R_1400_1499,
        .u8MipiLaneNum    = 4,
        .stSnsAttr        = &attr_4l_720p25,
        .u32SnsClk        = 27000000,
    },

    {
        .u32SnsFmt        = FORMAT_WDR_800WP25,
        .u32ConfSize      = sizeof(Sensor_Cfg_IMX485_MIPI_4LANE_WDR_800WP25) / 4,
        .pu16CciConf      = Sensor_Cfg_IMX485_MIPI_4LANE_WDR_800WP25,
        .u8MipiClkRate    = R_1400_1499,
        .u8MipiLaneNum    = 4,
        .stSnsAttr        = &attr_4l_wdr_800wp25,
        .u32SnsClk        = 27000000,
    },
};

const unsigned int IMX485RegToGain[241] =
{
