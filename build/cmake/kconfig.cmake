...
set(BOARD_DEFCONFIG ${BOARD_DIR}/${CMAKE_DEFCONFIG})
set(DOTCONFIG                  ${PROJECT_ROOT}/.config)
...
set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_menuconfig
  ${PROJECT_ROOT}/build/script/kconfig/menuconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_guiconfig
  ${PROJECT_ROOT}/build/script/kconfig/guiconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_hardenconfig
  ${PROJECT_ROOT}/build/script/kconfig/hardenconfig.py
  )
...
message(
  ${PYTHON_EXECUTABLE}
  ${PROJECT_ROOT}/build/script/kconfig/kconfig.py
