...
void fh_stepmotor_set_hw_param(struct fh_sm_obj_t* obj,struct fh_sm_param* param)
{
	...
	//printk("%s:%d (0x08) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_MODE, reg, readl(obj->regs+MOTOR_MODE));
	...
	//printk("%s:%d (0x0c) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_TIMING0, reg, readl(obj->regs+MOTOR_TIMING0));
	...
	//printk("%s:%d (0x10) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_TIMING1, reg, readl(obj->regs+MOTOR_TIMING1));
	...
	if (param->initparam.NeedUpdatePos) {
		...
		//printk("%s:%d (0x14) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_INIT, reg, readl(obj->regs+MOTOR_INIT));
	}
...
int fh_stepmotor_start_sync(struct fh_sm_obj_t* obj,int cycles)
{
	...
	//printk("%s:%d (0x10) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_TIMING1, regcycle, readl(obj->regs+MOTOR_TIMING1));

	writel(1,obj->regs+MOTOR_CTRL);
	//printk("%s:%d (0x00) addr[%p] wr[0x%x] rd[0x%x]\n", __FUNCTION__, __LINE__,obj->regs+MOTOR_CTRL, 1, readl(obj->regs+MOTOR_CTRL));
