...
#ifndef __MOLCHIP_FY12_H
#define __MOLCHIP_FY12_H

#define CONFIG_GICV3

#ifdef CONFIG_ARMV8_MULTIENTRY
#define RELEASE_CPU_ADDR	0x02400008
#define CPU_START_ADDR		0x02400010
#endif

#ifdef CONFIG_GICV3
#define GICD_BASE		0x1000000
#define GICR_BASE 		0x1060000
#endif
...
#define CONFIG_ENV_OFFSET		0x78000      /* environment starts here */
...
#define MY_STR_BOOTZIMAGE \
	"help;" \
	"sf probe 0;" \
	"sf read 0x40080000 0xA0000 0xF00000;" \
	"sf read 0x42000000 0xFA0000 0x8000;" \
	"sf read 0x80008000 0xFB0000 0xF00000;" \
	"sf read 0x81000000 0x1EB0000 0x8000;" \
	"booti 0x40080000 - 0x42000000; "
/* fail */
#define MY_STR_BOOTIMAGE \
	"help;" /*\
	"bootm 0x40008000 - 0x41000000; "*/

#define MY_STR_MMC_BOOTIMAGE \
	"mmc read 0x40080000 0x0 0x10000;" \
	"mmc read 0x42000000 0x10000 0x200;" \
	"mmc read 0x80008000 0x10200 0x10000;" \
	"mmc read 0x81000000 0x20200 0x200;" \
	"booti 0x40080000 - 0x42000000; "

#ifndef CONFIG_CMD_MMC
#define CONFIG_BOOTCOMMAND		MY_STR_BOOTZIMAGE
#else
#define CONFIG_BOOTCOMMAND		MY_STR_MMC_BOOTIMAGE
#endif

#define CONFIG_SPL_TEXT_BASE		0x1000
#define CONFIG_SPL_STACK		0x30807800
