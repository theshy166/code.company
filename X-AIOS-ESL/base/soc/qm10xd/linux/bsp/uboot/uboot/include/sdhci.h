...
#define   SDHCI_CTRL_HS_DDR		0x0004 /* Non-standard*/
#define   SDHCI_CTRL_HS200		0x0003 /* Non-standard*/
#define   SDHCI_CTRL_HS_SDR		0x0001 /* Non-standard*/
...
static inline u32 sdhci_get_sdma_addr(struct sdhci_host *host)
{
	return readl(host->ioaddr + SDHCI_ADMA_ADDRESS);
}
#endif
