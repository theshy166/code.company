cmd_sdl/arch/arm/lib/vectors.o := arm-molv2-linux-uclibcgnueabi-gcc -Wp,-MD,sdl/arch/arm/lib/.vectors.o.d -nostdinc -isystem /home/luoxin/work/X-AIOS-ESL/tools/toolchain/arm-molv2-linux-uclibcgnueabi/bin/../lib/gcc/arm-molv2-linux-uclibcgnueabi/10.3.1/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h -I../arch/arm/mach-molchip/include -D__KERNEL__ -D__UBOOT__ -DLOGO_YADDR0=0x43E00000 -DLOGO_CADDR0=0x43E98000 -DLOGO_YADDR1=0x00000000 -DLOGO_CADDR1=0x00000000 -DCONFIG_SDL_BUILD -D__ASSEMBLY__ -g -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7  -I../../arch/arm/mach-molchip/include -I../arch/arm/mach-molchip/include   -c -o sdl/arch/arm/lib/vectors.o ../arch/arm/lib/vectors.S

source_sdl/arch/arm/lib/vectors.o := ../arch/arm/lib/vectors.S

deps_sdl/arch/arm/lib/vectors.o := \
...
sdl/arch/arm/lib/vectors.o: $(deps_sdl/arch/arm/lib/vectors.o)
