...
static int32_t _dsi_phy_v0_deinit_param_set(dsi_phy_deinit_in_t *inParam, dsi_phy_deinit_out_t *outParam)
{
    ...
    dsiPhyContext->phyWorkMode[inParam->phyId] = DSI_PHY_WORK_NONE;
...
static int32_t _dsi_phy_v0_cfg(dsi_phy_init_in_t *inParam, dsi_phy_init_out_t *outParam)
{
    ...
    rtn = dsi_phy_set_txreadyesc_extend_vld(dsiPhyContext->phy_base_addr, com->txreadyesc_extend_vld); // 0x60 bit7-0
    rtn = dsi_phy_set_rxvalidesc_extend_vld(dsiPhyContext->phy_base_addr, com->rxvalidesc_extend_vld); // 0x60 bit15-8
...
int32_t dsi_phy_v0_deinit(dsi_phy_deinit_in_t *inParam, dsi_phy_deinit_out_t *outParam)
{
    ...
    dsiPhyContext->status[inParam->phyId] = DSI_UN_INITED;
