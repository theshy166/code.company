...
#define FORMAT_720P2   0x05
#define FORMAT_720P25  0x03
...
#if 0
    fh_printf("GetAEInfo currIntt=%d\n",stSnsAEInfo->currIntt);//160
    fh_printf("GetAEInfo currAGain=%d\n",stSnsAEInfo->currAGain);//64
    fh_printf("GetAEInfo CurrHsf=%d\n",stSnsAEInfo->currHsf);//28125
    fh_printf("GetAEInfo currFrameH=%d\n",stSnsAEInfo->currFrameH);//2000
#endif
    return 0;
}
#endif
