...
union _lcm_display_cfg_tag { /* 0x10B4 */
    struct _lcm_display_cfg_map {
        ...
        volatile unsigned int BTEXTSYNC_YUV_MODE            :2;  // default:h0
        volatile unsigned int SKIP_STEP0                    :1;  // default:h0    1:skip step0 for mcu interface display
        volatile unsigned int Reserved                      :1;  // default:h0    Reserved
