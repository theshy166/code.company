...
/* compatible arm64/arm. */
#ifdef __arm32__
typedef unsigned long long 	fy_paddr_t;
typedef unsigned int 		fy_vaddr_t;
typedef unsigned int		fy_vpointer_t;
#else
typedef unsigned long 		fy_paddr_t;
typedef unsigned long 		fy_vaddr_t;
typedef unsigned long		fy_vpointer_t;
#endif
