...
enum _lv_key_t {
    ...
    LV_KEY_F11,
    LV_KEY_F12,
    LV_KEY_VOLUME_DOWN  =114,
    LV_KEY_VOLUME_UP    =115,
    LV_KEY_PAGE_UP      =104,
    LV_KEY_PAGE_DOWN    =109,
    LV_KEY_PHONE     = 445, /* 0x1BD IPC PICKUP_PHONE*/
    LV_KEY_HANGUP,
    LV_KEY_RESET     = 511, /* 0x1FF IPC RESET*/
