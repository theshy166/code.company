...
if(CONFIG_XOS_USE_LVGL_DEMOS)
file(GLOB_RECURSE DEMO_SOURCES ${LVGL_ROOT_DIR}/demos/*.c)
endif()

if(CONFIG_XOS_USE_LVGL_EXAMPLES)
file(GLOB_RECURSE EXAMPLE_SOURCES ${LVGL_ROOT_DIR}/examples/*.c)
endif()

if(CONFIG_XOS_USE_LVGL_THORVG)
...
target_include_directories(lvgl PUBLIC ${XOS_INTERFACE_INC}
	${XOS_ROOT}/core/package/libnative/qlibffmpeg/include
	${XOS_ROOT}/core/package/libnative/qlibfreetype/include
	${XOS_ROOT}/core/package/libnative/qlibrlottie/include
	${XOS_ROOT}/core/package/libnative/qlibjpegturbo/include
	${XOS_ROOT}/core/package/libnative/qlibquammapi/include
)
