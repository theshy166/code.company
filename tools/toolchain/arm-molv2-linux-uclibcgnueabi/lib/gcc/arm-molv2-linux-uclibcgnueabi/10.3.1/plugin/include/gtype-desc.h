...
#define gt_ggc_m_30vec_cgraph_node__va_gc_atomic_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_cgraph_node__va_gc_atomic_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_cgraph_node__va_gc_atomic_ (void *);
...
#define gt_pch_n_30vec_cgraph_node__va_gc_atomic_(X) do { \
  if (X != NULL) gt_pch_nx_vec_cgraph_node__va_gc_atomic_ (X);\
  } while (0)
extern void gt_pch_nx_vec_cgraph_node__va_gc_atomic_ (void *);
...
extern void gt_pch_p_30hash_table_cgraph_edge_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_30vec_cgraph_node__va_gc_atomic_
    (void *, void *, gt_pointer_operator, void *);
