...
#define LV_POWERKEY_TIMEOUT  2000                   /*Press the power key timeount of milliseconds*/
...
#if USE_EVDEV || USE_BSD_EVDEV || LV_USE_EVDEV
#  define EVDEV_NAME   "/dev/input/event0"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
//#  define EVDEV_NAME   "/dev/input/mice"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
