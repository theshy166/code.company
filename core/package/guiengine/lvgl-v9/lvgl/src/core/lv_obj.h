...
struct _lv_obj_t {
    ...
    lv_draw_buf_t scroll_buf;
};

/**********************
 * GLOBAL PROTOTYPES
 **********************/
extern int qme_memory_alloc(unsigned int size, unsigned long *mmz_phy_buffer, void **mmz_virt_buffer);
extern int qme_memory_free(unsigned long mmz_phy_buffer, void *mmz_virt_buffer);
