...
#define XOS_ABILTIY_TTF_OUT_PATH0   "./out/simulator/res/ttf/2312.ttf"
#define XOS_ABILTIY_TTF_OUT_PATH1   "./simulator/res/ttf/2312.ttf"
#define XOS_ABILTIY_TTF_OUT_PATH2   "./res/ttf/2312.ttf"
#define XOS_ABILTIY_TTF_OUT_PATH3   "../res/ttf/2312.ttf"
...
enum {
    XOS_ABILITY_POWER_CTRL_ON,
    XOS_ABILITY_POWER_CTRL_OFF,
};

typedef struct _xos_ability_power_ctrl_t_{
    /* Save current power control status, on or off.  */
    /* 0: off, 1: on. */
    unsigned int power_key_status;

    /* Save the backlight brightness when screen off. */
    unsigned int backlight_brightness;
}xos_ability_power_ctrl_t;
