...
SPNG_API int spng_decode_block(spng_ctx *ctx, void *out, size_t *blk_bytes);
...
SPNG_API int spng_encode_block(spng_ctx *ctx, void *block, size_t block_len);
